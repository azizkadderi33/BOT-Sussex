...
module.exports.run = async function({ api, event, args }) {
	...
	let getPorn = (await axios.get(`https://i.postimg.cc/0N4GxYmy/278848207-1213870772696031-5942048368084357904-n.jpg`, { responseType: 'arraybuffer' })).data;
