module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "ساسكي",
  description: "صور 6-pack عشوائية",
...
"https://i.imgur.com/aV4WVsq.jpg"
     ...
     var callback = () => api.sendMessage({body:`حاول ان لا تصبح شاذا بعد رؤية الصور \n على مهلكن يا فتيات-.-`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
