...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://media4.giphy.com/media/iseq9MQgxo4aQ/giphy.webp?cid=6c09b9520c8016db9fefa88b96abadbc2494a20537679b91&rid=giphy.webp&ct=g", path);
}
