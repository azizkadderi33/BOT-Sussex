...
"https://i.imgur.com/ZSlCWrx.png",
    ...
    var ZiaRein2 = () => api.sendMessage({body: ` الانمي المقترح\n\nاضغط على الصورة لجودة افضل`, attachment: fs.createReadStream(__dirname + "/cache/ZiaRein1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/ZiaRein1.jpg"), event.messageID);
