...
//let song = args.join(" ");
  ...
  switch(args[0]) {
    ...
    break;
    default:
    return api.sendMessage(`⚠️من فضلك اكتب اسم احد العملات بعد الامر.\n\nالعملات المتاحة:\nEthereum\nTether\nBinance\nUSD Coin\nHEX\nSolana\nXRP\nTerra\nADA\nUST\nDOGE`, event.threadID, event.messageID);
    break;
  }
...
var callback = function () {
 api.sendMessage({ body:`الاسم: ${name}\nالرمز: ${symbol}\nالتصنيف: ${rank}\n الثمن بالدولار: ${price_usd}\nالثمن بالبتكوين: ${price_btc}\nالنسبة: ${percent_24h}`, attachment: fs.createReadStream(__dirname + '/cache/c.jpg')
