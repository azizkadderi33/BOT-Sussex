...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] لقد تم حذف مجموعتك من قائمة استكشاف البوت بسبب: ${lydo}`, idBox);
   	...
   	else api.sendMessage("[ تم بنجاح ] *(^_^)/* تمت المصادقة على المجموعة من طرف  凧\n☆ ┑(￣▽￣)┍ ☆\n ༻المالك:- ☞AZIZ☜ ༺\n ༒يمكنك مناداته 〠 凧〠.༒\n ༒حسابه على الفيسبوك༒:\n- ☞ https://www.facebook.com/profile.php?id=100003182359095 ☜ \n ֎تواصل معه على الواتساب֍ :-  ☞+213778460041 ☜", idBox, (error, info) => {
