module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "ساسكي",
  description: "اسف عالعنصرية :v",
  commandCategory: "بنرات",
...
if(!fs.existsSync(__dirname+'/cache/SVN-Arial 2.ttf')) { 
      let getfont = (await axios.get(`https://drive.google.com/u/0/uc?id=11YxymRp0y3Jle5cF𝐊𝐈𝐓𝐄 凧BmLzwU89XNqHIZux&export=download`, { responseType: "arraybuffer" })).data;
